...
namespace XArbete.Services.Migrations
{
    ...
    [Migration("20200128120614_remove isbreed kennecntets")]
    partial class removeisbreedkennecntets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XArbete.Domain.Models.Dog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("XArbete.Domain.Models.KennelContent", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("KennelContents");
                });

            modelBuilder.Entity("XArbete.Domain.Models.KennelContentSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("KennelContentId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("KennelContentSections");
                });
            ...
            modelBuilder.Entity("XArbete.Domain.Models.Dog", b =>
                {
                    b.HasOne("XArbete.Domain.Models.Customer", "Owner")
                        .WithMany("Dogs")
            ...
            modelBuilder.Entity("XArbete.Domain.Models.HotelBooking", b =>
                {
                    b.HasOne("XArbete.Domain.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XArbete.Domain.Models.Dog", "Dog")
                        .WithMany()
                        .HasForeignKey("DogID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
